...
function descendingComparator(a: any, b: any, orderBy: any) {
    ...
    const func = (a: any): string | number => {
        if (a instanceof Array) {
            return a.map((item: any) => func(item)).join(" ");
        } else if (typeof a == "string" || typeof a == "number") {
            return a;
        } else if (a?.props && a?.props?.children) {
            return func(a.props.children);
        }
        return "";
    }

    const A = func(a[orderBy]);
    const B = func(b[orderBy]);
                                ...
                                .map((row: any, index: number) => {
                                    ...
                                    return (
                                        <TableRow
                                            ...
                                            <TableCell>
                                                <Button aria-controls="simple-menu" aria-haspopup="true" onClick={() => alert("A")}>
                                                    Open Menu
</Button>
                                            </TableCell>
                                        </TableRow>
